...
JNIEXPORT jint JNICALL Java_com_weidi_jni_JniUtils_getIntFromC (JNIEnv *env, jclass obj, jint in){
	test();
	int in_ = in;
	LOGI("int:%d\n", in_);
	int in_2 = 888;
...
JNIEXPORT jbyte JNICALL Java_com_weidi_jni_JniUtils_getByteFromC (JNIEnv *env, jclass obj, jbyte bt){
	signed char bt_ = bt;
	LOGI("byte:%d\n", bt_);
...
JNIEXPORT jchar JNICALL Java_com_weidi_jni_JniUtils_getCharFromC (JNIEnv *env, jclass obj, jchar ch){
...
JNIEXPORT jboolean JNICALL Java_com_weidi_jni_JniUtils_getBooleanFromC (JNIEnv *env, jclass obj, jboolean bool){
...
JNIEXPORT jshort JNICALL Java_com_weidi_jni_JniUtils_getShortFromC (JNIEnv *env, jclass obj, jshort sh){
	short sh_ = sh;
	LOGI("short:%d\n", sh_);
	short sh_2 = 555;
...
JNIEXPORT jlong JNICALL Java_com_weidi_jni_JniUtils_getLongFromC (JNIEnv *env, jclass obj, jlong lg){
	long lg_ = lg;
	LOGI("long:%ld\n", lg_);
	long lg_2 = 77777777;
...
JNIEXPORT jfloat JNICALL Java_com_weidi_jni_JniUtils_getFloatFromC (JNIEnv *env, jclass obj, jfloat ft){
	float ft_ = ft;
	LOGI("float:%f\n", ft_);
	float ft_2 = 3333.;
...
JNIEXPORT jdouble JNICALL Java_com_weidi_jni_JniUtils_getDoubleFromC (JNIEnv *env, jclass obj, jdouble db){
	double db_ = db;
	LOGI("double:%lf\n", db_);
	double db_2 = 9999999;
...
JNIEXPORT jstring JNICALL Java_com_weidi_jni_JniUtils_getStringFromC (JNIEnv *env, jclass obj, jstring str){
	// 得到从java端传过来的字符串
...
JNIEXPORT jobjectArray JNICALL Java_com_weidi_jni_JniUtils_getStringArrayFromC (JNIEnv *env, jclass obj, jobjectArray objA){
	// 从java端得到对象数组
...
JNIEXPORT jintArray JNICALL Java_com_weidi_jni_JniUtils_getIntArrayFromC (JNIEnv *env, jclass obj, jintArray inA){
...
JNIEXPORT jbyteArray JNICALL Java_com_weidi_jni_JniUtils_getByteArrayFromC (JNIEnv *env, jclass obj, jbyteArray btA){
	...
	int i = 0;
	for (; i < leng; i++) {
		LOGI("------------->%d", byte_[i]);// byte:-128~127（赋值128实际值-128,赋值129实际值-127,赋值-128实际值127,赋值-129实际值126）
	}
...
// 测试已可以，中文字符还不能正确显示
JNIEXPORT jcharArray JNICALL Java_com_weidi_jni_JniUtils_getCharArrayFromC (JNIEnv *env, jclass obj, jcharArray chA){
...
// 测试已可以
JNIEXPORT jbooleanArray JNICALL Java_com_weidi_jni_JniUtils_getBooleanArrayFromC (JNIEnv *env, jclass obj, jbooleanArray boolA){
...
JNIEXPORT jshortArray JNICALL Java_com_weidi_jni_JniUtils_getShortArrayFromC (JNIEnv *env, jclass obj, jshortArray shA){

}

JNIEXPORT jlongArray JNICALL Java_com_weidi_jni_JniUtils_getLongArrayFromC (JNIEnv *env, jclass obj, jlongArray lgA){

}

JNIEXPORT jfloatArray JNICALL Java_com_weidi_jni_JniUtils_getFloatArrayFromC (JNIEnv *env, jclass obj, jfloatArray ftA){

}

JNIEXPORT jdoubleArray JNICALL Java_com_weidi_jni_JniUtils_getDoubleArrayFromC (JNIEnv *env, jclass obj, jdoubleArray dbA){

}

/**********************************************************************************************************************************************************/

JNIEXPORT jobject JNICALL Java_com_weidi_jni_JniUtils_getObjectFromC (JNIEnv *env, jclass obj, jobject obje){
...
//	jobject object_3 = (*env)->AllocObject(env, objectClass);
	jmethodID methodId_2 = (*env)->GetMethodID(env, objectClass, "setName", "(Ljava/lang/String;)V");
	// 得到构造方法ID
...
JNIEXPORT jobjectArray JNICALL Java_com_weidi_jni_JniUtils_getObjectArrayFromC (JNIEnv *env, jclass obj, jobjectArray objArray){
